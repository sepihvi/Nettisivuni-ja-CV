...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#">Minun Nettisivuni</a>
    ...
    <section class="container my-5">
        ...
        <div class="text-center mt-5">
            ...
            <p class="lead">Löydät minut myös seuraavista kanavista:</p>
            <a href="https://www.linkedin.com/in/hugo-korhonen-3260052b6?utm_source=share&utm_content=profile&utm_medium=android_app" class="btn btn-outline-primary btn-lg mx-2" target="_blank"><i class="fab fa-linkedin"></i> LinkedIn</a>
            <a href="https://www.instagram.com//hugo.korhonen/profilecard/?igsh=bjgyemY4cHJiMDZ4" class="btn btn-outline-danger btn-lg mx-2" target="_blank"><i class="fab fa-instagram"></i> Instagram</a>
            <a href="https://github.com/sepihvi" class="btn btn-outline-dark btn-lg mx-2" target="_blank"><i class="fab fa-github"></i> GitHub</a>
        </div>
    </section>

    <!-- Bootstrap JS ja Popper -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    <footer>
        <p style="text-align: center;">
        Tekijä: Hugo Korhonen
        <a href="nettisivu3.php" class="btn btn-primary btn-lg mt-3">Yhteydenotto</a>
        </p>
    </footer>
</body>
</html>
